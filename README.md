...
> *"Chaque projet est une nouvelle occasion d'apprendre quelque chose."*

Je suis un **étudiant en informatique**, passionné par le développement, les nouvelles technologies et l'aviation.

J'aime créer des projets utiles, expérimenter de nouvelles idées et apprendre de nouveaux langages.
...
<img src="https://skillicons.dev/icons?i=html,css,javascript,python,java,cs,cpp,git,github,vscode,windows,linux"/>
...
- 📚 Continuer à progresser chaque jour
...
|---------|-------------|--------|
| Velkora-Client | Lanceur Minecraft personnalisé sans API ni publicité | 🟢 Terminé (mais toujours en dev' car bug / version à ajouté !) |
...
<details>
<summary>📖 Quelques informations supplémentaires</summary>
...
- ✈️ Passionné de Flight Simulator
- 💻 J'aime créer des outils utiles
- 🚀 J'aime découvrir de nouvelles technologies
- 🎮 Je joue aussi pendant mon temps libre 😄
...
Si un projet te plaît, pense à lui laisser une ⭐ !
